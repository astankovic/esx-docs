...
|---------|----------|---------|
| "Poll must have votes to finalize" | Error | No responses yet—share the invite link and wait for [Participating and Voting](participating-and-voting). |
...
- For viewing live results before finalizing, see 4.1. Viewing Results; for team polls, explore [Spaces and Team Collaboration](spaces-and-team-collaboration). To create new polls, return to [Creating and Sharing Polls](creating-and-sharing-polls).