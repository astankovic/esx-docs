...
For creating polls post-login, see [Creating Your First Poll](creating-your-first-poll). Manage account details in [User Settings and Preferences](user-settings-and-preferences). Team logins relate to [Managing Members](managing-members) in spaces.