...
|---------------|---------|--------|
| *Increase the number of seats in this space from the billing page.* | Cloud-hosted, no seats left. | Click **billing page** link to [Billing and Subscriptions](billing-and-subscriptions). |
...
For Space overviews, see [Spaces and Team Collaboration](spaces-and-team-collaboration) and [Space Dashboard](space-dashboard). Adjust plans in [Billing and Subscriptions](billing-and-subscriptions). Notifications for invites appear in [User Settings and Preferences](user-settings-and-preferences).